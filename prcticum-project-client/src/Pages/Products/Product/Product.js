            ...
            <div className="w-[40%] mt-10">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className={`w-[50%] tooltip flex-col justify-center items-center  ${
                    isProductInCart ? "cursor-not-allowed" : ""
                  }`}
                  disabled={isProductInCart}
                >
                  {isProductInCart ? (
                    <button className='cursor-not-allowed bg-green-600  px-5 py-2 rounded-[4px]  border-2    text-white text-lg m-5 hover:duration-500'>Added</button>
                  ) : (
              ...
              <div className="flex-wrap   justify-between ">
                <div className="flex items-center my-7">
                  ...
                  <div className="ml-5">
                    ...
                    <p>
                      For all orders over <span className="text-xl">৳ </span>
                      3000
                    </p>
                  </div>
                </div>
